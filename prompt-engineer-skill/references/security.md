# Prompt Security & Injection Defense (Late-June 2026)
...
| **Promptfoo red-team** | Promptfoo (open source) | `npx promptfoo@latest redteam setup`; 50+ attack plugins across prompt injection, jailbreaks, PII leakage, SSRF, SQLi; automated red teaming for agents & RAGs, CI/CD integration, HarmBench integration. |
